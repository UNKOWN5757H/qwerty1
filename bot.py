...
buttons.append([InlineKeyboardButton(f"❌ {file_name} ({file_size})", callback_data=f"edit_delete_{batch_id}{i}")])
buttons.append([
InlineKeyboardButton("➕ Add More Files", callback_data=f"edit_add{batch_id}"),
...
try:
_, , payment_id = query.data.split("", 2)
except Exception:
